...
ggsave(paste0("dot_plot_full", Sys.Date(), ".pdf"), width = 7, height = 7)


## save to pdf page
ggsave(paste0("dot_plot", Sys.Date(), ".pdf"), width = 4, height = 4)

## save to png
ggsave(paste0("dot_plot", Sys.Date(), ".png"), width = 4, height = 4, dpi = 100)
